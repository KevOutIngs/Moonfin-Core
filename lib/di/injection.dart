...
/// Registers what a headless engine needs to restore a session. With
/// [offline] it also brings up the downloads storage, enough for
/// `setActiveServerClient` to build a download service.
