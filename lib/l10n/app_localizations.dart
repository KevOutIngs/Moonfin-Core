...
abstract class AppLocalizations {
  ...
  String get autoDownloadDeleteTitle;
  ...
  /// In en, this message translates to:
  /// **'Followed series'**
  String get autoDownloadSubscriptions;
  ...
  /// In en, this message translates to:
  /// **'Remote message'**
  String get remoteMessageNotificationTitle;

  /// System notification body for a server message with empty text
  ///
  /// In en, this message translates to:
  /// **'Message received'**
  String get remoteMessageNotificationReceived;
